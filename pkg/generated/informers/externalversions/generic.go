...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=healthmonitor.confluent.io, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("deploymenthealthmonitors"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Healthmonitor().V1alpha1().DeploymentHealthMonitors().Informer()}, nil
